...
class BadgeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge_type" do
    assert_difference('BadgeType.count') do
      post badge_types_url, params: { badge_type: { name: @badge_type.name, type: @badge_type.type } }
    end
  ...
  test "should update badge_type" do
    patch badge_type_url(@badge_type), params: { badge_type: { name: @badge_type.name, type: @badge_type.type } }
