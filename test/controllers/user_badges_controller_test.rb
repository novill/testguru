...
class UserBadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_badge" do
    assert_difference('UserBadge.count') do
      post user_badges_url, params: { user_badge: { badge_id: @user_badge.badge_id, count: @user_badge.count, user_id: @user_badge.user_id } }
    end
  ...
  test "should update user_badge" do
    patch user_badge_url(@user_badge), params: { user_badge: { badge_id: @user_badge.badge_id, count: @user_badge.count, user_id: @user_badge.user_id } }
