...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { active: @badge.active, badge_type_id: @badge.badge_type_id, object_id: @badge.object_id, object_type: @badge.object_type } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { active: @badge.active, badge_type_id: @badge.badge_type_id, object_id: @badge.object_id, object_type: @badge.object_type } }
