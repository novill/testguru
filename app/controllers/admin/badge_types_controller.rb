class Admin::BadgeTypesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @badge_type.save
        format.html { redirect_to admin_badge_type_path(@badge_type), notice: 'Badge type was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @badge_type.update(badge_type_params)
        format.html { redirect_to admin_badge_type_path( @badge_type ), notice: 'Badge type was successfully updated.' }
      else
  ...
  def destroy
    @badge_type.destroy
    respond_to do |format|
      format.html { redirect_to admin_badge_types_url, notice: 'Badge type was successfully destroyed.' }
    end
  end
  ...
  private
    ...
    def badge_type_params
      params.require(:badge_type).permit(:b_type, :name)
    end
end
